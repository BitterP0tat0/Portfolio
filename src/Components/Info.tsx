...
export default function Info() {
  return (
    <div className=" mt-auto relative overflow-hidden bg-gradient-to-tr from-gray-700 via-gray-900 to-black py-16 sm:py-20 ">
      <BackgroundBeamsWithCollision className="bg-gradient-to-tr from-gray-700 via-gray-900 to-black opacity-80  ">
        ...
        <div className="flex flex-wrap absolute justify-center top-0 content-center">
          ...
          <main className="flex mt-10 text-center max-w-100">
            <p className="text-lg text-white flex flex-wrap tracking-wide max-w-13 px-4 py-2 transition-all duration-300 ease-in-out hover:text-cyan-400 hover:opacity-80 hover:transform hover:scale-95">
